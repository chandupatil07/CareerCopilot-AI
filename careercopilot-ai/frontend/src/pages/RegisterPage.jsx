    ...
    <div style={splitScreenStyle} className="animate-fade-in register-split-viewport">
      ...
      <div style={formColumnStyle}>
        <div style={{ maxWidth: '380px', width: '100%', margin: '0 auto' }}>
          ...
          {error && (
            <div style={{ backgroundColor: 'rgba(239, 68, 68, 0.1)', color: 'var(--color-danger)', border: '1px solid rgba(239, 68, 68, 0.2)', padding: '0.6rem', borderRadius: 'var(--border-radius-md)', marginBottom: '1rem', fontSize: '0.85rem', textAlign: 'center' }}>
              ⚠️ {error}
            </div>
          )}
